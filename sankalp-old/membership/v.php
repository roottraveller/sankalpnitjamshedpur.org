...
$sql="insert INTO volunteer (fname,lname,email,address,phone,whyjoin,howhelp,branch,dob,batch,gender,image) VALUES ('$fname','$lname','$email','$address','$phone','$whyjoin','$howhelp','$branch','$dob','$batch','$gender','$link')";
if(mysql_query($sql))
 {  ?>
  <?php
error_reporting(0);
