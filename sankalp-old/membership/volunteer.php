...
<div class="col2">    
 ...
 <form action="vol.php" method="post" onSubmit="return validateForm()" name="FORMTEST" enctype="multipart/form-data"  onreset="return confirm('Are you sure you want to reset this form  ??');">
 <table class="join_us">
